...
class AccountDeactiviatonSheet extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
              child: Text("Your account will be deactivated and you will not be able to use letterbird. This action can not be undone.",
