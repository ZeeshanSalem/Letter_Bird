          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: Text("Privacy Policy", style: kufamTextStyle.copyWith(
                ...
                Expanded(
                  child: RawScrollbar(
                    ...
                    child: ListView(
                      children: [
                        Text("1.Rhoncus commodo volutpat et in dui habitant sit. Eros, morbi in consequat, iaculis a urna. Quis senectus pulvinar id nec et et tempor, felis. Auctor bibendum iaculis pellentesque metus, potenti. At eleifend risus, tellus amet, in lobortis et feugiat habitant. Habitasse quis nulla enim nec. Id dui quam ultricies ornare",style: kufamTextStyle.copyWith(
                        color: textColor,
                          fontSize: 18.sp,
                          height: 2.0,
                      ),),
