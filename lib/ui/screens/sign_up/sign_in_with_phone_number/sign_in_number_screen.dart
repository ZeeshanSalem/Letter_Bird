...
class SignInWithNumberScreen extends StatefulWidget {
  @override
  _SignUpEnterNumberScreenState createState() => _SignUpEnterNumberScreenState();
}

class _SignUpEnterNumberScreenState extends State<  SignInWithNumberScreen> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: ChangeNotifierProvider(
          create: (context) => SignInWithNumberViewModel(),
          child: Consumer<SignInWithNumberViewModel>(
