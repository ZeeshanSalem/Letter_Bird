...
class SettingUserAgreementScreen extends StatelessWidget {
  @override
                  ...
                  child: Padding(
                    ...
                    child: ListView(
                      children: [
                        ...
                        Text("In diam lorem tincidunt in. In purus fringilla viverra orci nulla. ScelerisDolor sed lacus, nisl netus. A, non facilisis metus fringilla ullamcorper ultrices cursus. Sem lacus scelerisque amet faucibus. Odio laoreet senectus sed orci lectus etiam nunc. In diam lorem tincidunt in. In purus fringilla viverra orci nulla. ScelerisDolor sed lacus, nisl netus. A, non facilisis metus fringilla ullamcorper ultrices cursus. Sem lacus scelerisque amet faucibus. Odio laoreet senectus sed orci lectus etiam nunc. In diam lorem tincidunt in. In purus fringilla viverra orci nulla. Sceleris",
                          style: kufamTextStyle.copyWith(
                            color: textColor,
                            fontSize: 18.sp,
                            height: 2.0,
