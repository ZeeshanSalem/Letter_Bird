...
class FavoriteLetter extends StatelessWidget {
  const FavoriteLetter({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => FavoriteLetterViewModel(),
      child: Consumer<FavoriteLetterViewModel>(
                ...
                body: Column(
                  children: [
                    ...
                    model.state == ViewState.loading
                        ...
                        : Expanded(
                            child: model.favoriteLetterList.length == 0
                                ? Column(
                                    children: [
                                      Padding(
                                        ...
                                        child: textView(
                                            text:
                                                "Your favorites box is empty, wait for your letter friend to reply your letter or write a new letter to another letterbird user.",
                                            fontSize: 14,
                                ...
                                : ListView.builder(
                                    ...
                                    itemCount: model.favoriteLetterList.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      return _buildListItem(
                                          model.favoriteLetterList[index]);
                                      // return Container(
                                      //   // height: 50,
  ...
  Widget _buildListItem(FavoriteLetterModel item) {
    return Container(
