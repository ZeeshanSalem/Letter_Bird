...
class DraftsLetter extends StatelessWidget {
  const DraftsLetter({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => DraftsLetterViewModel(),
      child: Consumer<DraftsLetterViewModel>(
          builder: (context, model, child) =>
              SafeArea(
                  child: Scaffold(
                      ...
                      children: [
                        ...
                        model.state == ViewState.loading
                          ...
                          child: Platform.isAndroid
                            ...
                            : Expanded(
                          child: model.draftsLetterList.length == 0
                              ? Column(
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(left: 45,
                                    ...
                                    top: 30),
                                child: textView(
                                    text: "Your draft box is empty, wait for your letter friend to reply your letter or write a new letter to another letterbird user.",
                                    fontSize: 14,
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 55,
                                    right: 55,
                                    top: 50),
                                child: RoundedButton(text: "Match",
                              ...
                              itemCount: model.draftsLetterList.length,
                              itemBuilder: (BuildContext context, int index) {
                                return _buildListItem(
                                    model.draftsLetterList[index]);
                                // return Container(
                                //   // height: 50,
  ...
  Widget _buildListItem(DraftsLetterModel item) {
    return Container(
      ...
      child: Padding(
        ...
        child: Stack(
          children: [
            Image.asset(item.backgroundImage, fit: BoxFit.fill,),
            Container(
                margin: EdgeInsets.only(
                    left: 5, top: 15, right: 25, bottom: 25),
                child:
